...
export function EmbedOptions({ profile }: EmbedOptionsProps) {
  ...
  <iframe 
    src="https://fastfasts-embed.lookhu.workers.dev/?id=${selectedChannelId}&skin=${selectedSkin}&autoplay=${settings.autoPlay ?? true}&muted=${settings.muted ?? true}&controls=${settings.controls ?? true}" 
